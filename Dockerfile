...
RUN apk add --no-cache bash openssh-server openssh-keygen git freetype libpng libjpeg-turbo freetype-dev libpng-dev libjpeg-turbo-dev py-pygments sudo sed \
